...
public class BoardService {
    ...
    public BoardDto create(String name, String password, String type) {
        Board board = Board.builder()
                .name(name)
    ...
    public BoardDto updatePassword(Integer idx, String password) {
        ...
        board.setPassword(normalizePassword(password));
    ...
    public BoardDto update(Integer idx, String name, String password, String type) {
        Board board = boardRepository.findById(idx)
                .orElseThrow(() -> new IllegalArgumentException("게시판을 찾을 수 없습니다."));
